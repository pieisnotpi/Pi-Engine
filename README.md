...
<br> 1. This engine requires the following three libraries to function and has been tested on the following versions: LWJGL 3.0.1 build 32 and JOML 1.8.4. Future versions of the stated libraries may work, but are not tested.
