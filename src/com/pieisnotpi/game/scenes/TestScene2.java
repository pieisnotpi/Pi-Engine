...
public class TestScene2 extends PauseScene
{
    ...
    public TestScene2 init()
    {
        ...
        ADSMaterial blockMaterial = new ADSMaterial(new Vector3f(0.2f), new Vector3f(0.2f), new Vector3f(0.1f), 10, Camera.PERSP, Texture.getTextureFile("metal"));
        ...
        Text text3D = new Text(font, t3dt, new Vector3f(0, 1.5f, 0), new Color(1, 0, 0), new Color(0, 0, 0), Camera.PERSP, this, new RainbowEffect(0.6f));
        text3D.getTransform().setParent(blocksMesh.getTransform()).setTranslate(-4, 2, 0).setScale(0.01f, 0.01f, 0.01f);

        Text text3D2 = new Text(PixelFont.getFont(), t3d2t, new Vector3f(0, 1.5f, 0.025f), new Color(0, 1, 0), new Color(0, 0, 0), Camera.PERSP, this, new WaveEffect(4, 0.1f, 5));
